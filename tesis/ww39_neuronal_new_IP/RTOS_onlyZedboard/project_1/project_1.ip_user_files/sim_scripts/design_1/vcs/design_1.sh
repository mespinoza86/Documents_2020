...
#
# Generated by Vivado on Sat Jan 04 17:22:37 CST 2020
...
compile()
{
  ...
  vlogan -work processing_system7_bfm_v2_0_5 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.srcs/sources_1/bd/design_1/ipshared/7dd0/hdl" \
    "$ref_dir/../../../../project_1.srcs/sources_1/bd/design_1/ipshared/7dd0/hdl/processing_system7_bfm_v2_0_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.srcs/sources_1/bd/design_1/ipshared/7dd0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/marco/Documents/tesis/ww39_neuronal_new_IP/RTOS_onlyZedboard/project_1/project_1.cache/compile_simlib/vcs"
  fi
