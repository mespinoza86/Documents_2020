...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../RTOS.srcs/sources_1/bd/design_1/ipshared/7dd0/hdl" \
       +incdir+"$ref_dir/../../../../RTOS.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"../../../../RTOS.srcs/sources_1/bd/design_1/ipshared/7dd0/hdl" \
       +incdir+"../../../../RTOS.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
