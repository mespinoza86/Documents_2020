...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/marco/Documents/tesis/FreeRTOSexample/FreeRTOS_example_ww37_Xilix_2016/vivado_for_RTOS_petalinux/RTOS/RTOS.cache/compile_simlib/riviera"
  fi
