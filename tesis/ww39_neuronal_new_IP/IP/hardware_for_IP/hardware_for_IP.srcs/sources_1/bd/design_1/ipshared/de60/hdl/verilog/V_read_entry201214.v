...
always @ (*) begin
    ap_condition_126 = ((scalar_simConfig_rowsToSimulate_V_empty_n == 1'b0) | (scalar_simConfig_BLOCK_NUMBERS_V_empty_n == 1'b0) | (simConfig_rowsToSimulate_V_out_full_n == 1'b0) | (simConfig_BLOCK_NUMBERS_V_out_full_n == 1'b0) | (simConfig_rowBegin_V_empty_n == 1'b0) | (simConfig_rowBegin_V_channel_i_full_n == 1'b0) | (simConfig_rowEnd_V_empty_n == 1'b0) | (simConfig_rowEnd_V_channel_i_full_n == 1'b0) | (simConfig_rowsToSimulate_V_channel_i_full_n == 1'b0) | (simConfig_BLOCK_NUMBERS_V_channel_i_full_n == 1'b0) | (simConfig_BLOCK_NUMBERS_V_channel1_i_full_n == 1'b0) | (V_SIZE_channel_i_full_n == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1));
end
