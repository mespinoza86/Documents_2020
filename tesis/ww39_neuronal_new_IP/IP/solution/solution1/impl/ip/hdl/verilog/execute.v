...
input  [26:0] simConfig_rowBegin_V;
...
input   ap_clk;
input   ap_rst;
input   simConfig_rowBegin_V_ap_vld;
...
wire    execute_entry206_U0_ap_start;
wire    execute_entry206_U0_ap_done;
wire    execute_entry206_U0_ap_continue;
wire    execute_entry206_U0_ap_idle;
wire    execute_entry206_U0_ap_ready;
wire    execute_entry206_U0_start_out;
wire    execute_entry206_U0_start_write;
wire   [26:0] execute_entry206_U0_simConfig_rowBegin_V_out_din;
wire    execute_entry206_U0_simConfig_rowBegin_V_out_write;
wire   [26:0] execute_entry206_U0_simConfig_rowEnd_V_out_din;
wire    execute_entry206_U0_simConfig_rowEnd_V_out_write;
wire   [26:0] execute_entry206_U0_simConfig_rowsToSimulate_V_out_din;
wire    execute_entry206_U0_simConfig_rowsToSimulate_V_out_write;
wire   [26:0] execute_entry206_U0_simConfig_BLOCK_NUMBERS_V_out_din;
wire    execute_entry206_U0_simConfig_BLOCK_NUMBERS_V_out_write;
wire   [31:0] execute_entry206_U0_size_out_din;
wire    execute_entry206_U0_size_out_write;
wire   [31:0] execute_entry206_U0_size_out1_din;
wire    execute_entry206_U0_size_out1_write;
...
wire   [26:0] blockControl_U0_simConfig_rowsToSimulate_V_out_din;
wire    blockControl_U0_simConfig_rowsToSimulate_V_out_write;
wire   [26:0] blockControl_U0_simConfig_BLOCK_NUMBERS_V_out_din;
wire    blockControl_U0_simConfig_BLOCK_NUMBERS_V_out_write;
...
wire    I_calc_U0_simConfig_rowsToSimu_read;
...
wire    ap_hs_continue;
wire    simConfig_rowBegin_V_1_full_n;
wire   [26:0] simConfig_rowBegin_V_1_dout;
wire    simConfig_rowBegin_V_1_empty_n;
wire    simConfig_rowEnd_V_c_full_n;
wire   [26:0] simConfig_rowEnd_V_c_dout;
wire    simConfig_rowEnd_V_c_empty_n;
wire    simConfig_rowsToSimu_6_full_n;
wire   [26:0] simConfig_rowsToSimu_6_dout;
wire    simConfig_rowsToSimu_6_empty_n;
wire    simConfig_BLOCK_NUMB_5_full_n;
wire   [26:0] simConfig_BLOCK_NUMB_5_dout;
wire    simConfig_BLOCK_NUMB_5_empty_n;
wire    size_channel_full_n;
wire   [31:0] size_channel_dout;
wire    size_channel_empty_n;
wire    size_channel15_full_n;
wire   [31:0] size_channel15_dout;
wire    size_channel15_empty_n;
...
reg    ap_sync_reg_execute_entry206_U0_ap_ready;
wire    ap_sync_execute_entry206_U0_ap_ready;
reg   [1:0] execute_entry206_U0_ap_ready_count;
wire    ap_sync_blockControl_U0_ap_start;
wire    ap_sync_execute_entry206_U0_ap_start;
...
#0 blockControl_U0_ap_ready_count = 2'b00;
#0 ap_sync_reg_execute_entry206_U0_ap_ready = 1'b0;
#0 execute_entry206_U0_ap_ready_count = 2'b00;
end

execute_entry206 execute_entry206_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(execute_entry206_U0_ap_start),
    .start_full_n(start_for_execute_Block_codeRe_U0_full_n),
    .ap_done(execute_entry206_U0_ap_done),
    .ap_continue(execute_entry206_U0_ap_continue),
    .ap_idle(execute_entry206_U0_ap_idle),
    .ap_ready(execute_entry206_U0_ap_ready),
    .start_out(execute_entry206_U0_start_out),
    .start_write(execute_entry206_U0_start_write),
    .p_read(simConfig_rowBegin_V),
    .p_read1(simConfig_rowEnd_V_r),
    .p_read2(simConfig_rowsToSimu),
    .p_read3(simConfig_BLOCK_NUMB),
    .size(size),
    .simConfig_rowBegin_V_out_din(execute_entry206_U0_simConfig_rowBegin_V_out_din),
    .simConfig_rowBegin_V_out_full_n(simConfig_rowBegin_V_1_full_n),
    .simConfig_rowBegin_V_out_write(execute_entry206_U0_simConfig_rowBegin_V_out_write),
    .simConfig_rowEnd_V_out_din(execute_entry206_U0_simConfig_rowEnd_V_out_din),
    .simConfig_rowEnd_V_out_full_n(simConfig_rowEnd_V_c_full_n),
    .simConfig_rowEnd_V_out_write(execute_entry206_U0_simConfig_rowEnd_V_out_write),
    .simConfig_rowsToSimulate_V_out_din(execute_entry206_U0_simConfig_rowsToSimulate_V_out_din),
    .simConfig_rowsToSimulate_V_out_full_n(simConfig_rowsToSimu_6_full_n),
    .simConfig_rowsToSimulate_V_out_write(execute_entry206_U0_simConfig_rowsToSimulate_V_out_write),
    .simConfig_BLOCK_NUMBERS_V_out_din(execute_entry206_U0_simConfig_BLOCK_NUMBERS_V_out_din),
    .simConfig_BLOCK_NUMBERS_V_out_full_n(simConfig_BLOCK_NUMB_5_full_n),
    .simConfig_BLOCK_NUMBERS_V_out_write(execute_entry206_U0_simConfig_BLOCK_NUMBERS_V_out_write),
    .size_out_din(execute_entry206_U0_size_out_din),
    .size_out_full_n(size_channel_full_n),
    .size_out_write(execute_entry206_U0_size_out_write),
    .size_out1_din(execute_entry206_U0_size_out1_din),
    .size_out1_full_n(size_channel15_full_n),
    .size_out1_write(execute_entry206_U0_size_out1_write)
);
...
execute_Block_codeRe execute_Block_codeRe_U0(
    ...
    .size_dout(size_channel15_dout),
    .size_empty_n(size_channel15_empty_n),
...
blockControl blockControl_U0(
    ...
    .simConfig_rowsToSimulate_V_dout(simConfig_rowsToSimu_6_dout),
    .simConfig_rowsToSimulate_V_empty_n(simConfig_rowsToSimu_6_empty_n),
    ...
    .V_SIZE_dout(size_channel_dout),
    .V_SIZE_empty_n(size_channel_empty_n),
    .V_SIZE_read(blockControl_U0_V_SIZE_read),
    .simConfig_rowsToSimulate_V_out_din(blockControl_U0_simConfig_rowsToSimulate_V_out_din),
    .simConfig_rowsToSimulate_V_out_full_n(simConfig_rowsToSimu_5_full_n),
    .simConfig_rowsToSimulate_V_out_write(blockControl_U0_simConfig_rowsToSimulate_V_out_write),
    .simConfig_BLOCK_NUMBERS_V_out_din(blockControl_U0_simConfig_BLOCK_NUMBERS_V_out_din),
    .simConfig_BLOCK_NUMBERS_V_out_full_n(simConfig_BLOCK_NUMB_4_full_n),
    .simConfig_BLOCK_NUMBERS_V_out_write(blockControl_U0_simConfig_BLOCK_NUMBERS_V_out_write),
...
V_read V_read_U0(
    ...
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .simConfig_rowBegin_V_dout(simConfig_rowBegin_V_1_dout),
    .simConfig_rowBegin_V_empty_n(simConfig_rowBegin_V_1_empty_n),
...
I_calc I_calc_U0(
    ...
    .simConfig_rowsToSimu_dout(simConfig_rowsToSimu_2_dout),
    .simConfig_rowsToSimu_empty_n(simConfig_rowsToSimu_2_empty_n),
    .simConfig_rowsToSimu_read(I_calc_U0_simConfig_rowsToSimu_read),
...
execute_simConfigBew simConfig_rowBegin_V_1_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(execute_entry206_U0_simConfig_rowBegin_V_out_din),
    .if_full_n(simConfig_rowBegin_V_1_full_n),
    .if_write(execute_entry206_U0_simConfig_rowBegin_V_out_write),
    .if_dout(simConfig_rowBegin_V_1_dout),
    .if_empty_n(simConfig_rowBegin_V_1_empty_n),
...
execute_simConfigCeG simConfig_rowEnd_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(execute_entry206_U0_simConfig_rowEnd_V_out_din),
    .if_full_n(simConfig_rowEnd_V_c_full_n),
    .if_write(execute_entry206_U0_simConfig_rowEnd_V_out_write),
...
execute_simConfigDeQ simConfig_rowsToSimu_6_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(execute_entry206_U0_simConfig_rowsToSimulate_V_out_din),
    .if_full_n(simConfig_rowsToSimu_6_full_n),
    .if_write(execute_entry206_U0_simConfig_rowsToSimulate_V_out_write),
    .if_dout(simConfig_rowsToSimu_6_dout),
    .if_empty_n(simConfig_rowsToSimu_6_empty_n),
...
execute_simConfigEe0 simConfig_BLOCK_NUMB_5_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(execute_entry206_U0_simConfig_BLOCK_NUMBERS_V_out_din),
    .if_full_n(simConfig_BLOCK_NUMB_5_full_n),
    .if_write(execute_entry206_U0_simConfig_BLOCK_NUMBERS_V_out_write),
...
execute_size_chanFfa size_channel_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(execute_entry206_U0_size_out_din),
    .if_full_n(size_channel_full_n),
    .if_write(execute_entry206_U0_size_out_write),
    .if_dout(size_channel_dout),
    .if_empty_n(size_channel_empty_n),
...
execute_size_chanGfk size_channel15_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(execute_entry206_U0_size_out1_din),
    .if_full_n(size_channel15_full_n),
    .if_write(execute_entry206_U0_size_out1_write),
    .if_dout(size_channel15_dout),
    .if_empty_n(size_channel15_empty_n),
...
execute_simConfigIfE simConfig_rowsToSimu_5_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(blockControl_U0_simConfig_rowsToSimulate_V_out_din),
    .if_full_n(simConfig_rowsToSimu_5_full_n),
    .if_write(blockControl_U0_simConfig_rowsToSimulate_V_out_write),
...
execute_simConfigJfO simConfig_BLOCK_NUMB_4_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(blockControl_U0_simConfig_BLOCK_NUMBERS_V_out_din),
    .if_full_n(simConfig_BLOCK_NUMB_4_full_n),
    .if_write(blockControl_U0_simConfig_BLOCK_NUMBERS_V_out_write),
...
execute_simConfig2iS simConfig_rowsToSimu_2_U(
    ...
    .if_read(I_calc_U0_simConfig_rowsToSimu_read)
);
...
start_for_executebck start_for_executebck_U(
    ...
    .if_write(execute_entry206_U0_start_write),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_execute_entry206_U0_ap_ready <= 1'b0;
    end else begin
        if ((1'b1 == (ap_start & ap_hs_ready))) begin
            ap_sync_reg_execute_entry206_U0_ap_ready <= 1'b0;
        end else begin
            ap_sync_reg_execute_entry206_U0_ap_ready <= ap_sync_execute_entry206_U0_ap_ready;
        end
    end
end

always @ (posedge ap_clk) begin
    if (((blockControl_U0_ap_ready == 1'b0) & (1'b1 == ap_hs_ready))) begin
        blockControl_U0_ap_ready_count <= (blockControl_U0_ap_ready_count - ap_const_lv2_1);
    end else if (((1'b1 == blockControl_U0_ap_ready) & (ap_hs_ready == 1'b0))) begin
        blockControl_U0_ap_ready_count <= (blockControl_U0_ap_ready_count + ap_const_lv2_1);
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_hs_ready) & (execute_entry206_U0_ap_ready == 1'b0))) begin
        execute_entry206_U0_ap_ready_count <= (execute_entry206_U0_ap_ready_count - ap_const_lv2_1);
    end else if (((ap_hs_ready == 1'b0) & (execute_entry206_U0_ap_ready == 1'b1))) begin
        execute_entry206_U0_ap_ready_count <= (execute_entry206_U0_ap_ready_count + ap_const_lv2_1);
    end
end
...
assign ap_hs_done = I_calc_U0_ap_done;

assign ap_hs_ready = (ap_sync_blockControl_U0_ap_ready & ap_sync_execute_entry206_U0_ap_ready);

assign ap_idle = (execute_entry206_U0_ap_idle & execute_Block_codeRe_U0_ap_idle & blockControl_U0_ap_idle & V_read_U0_ap_idle & calc_U0_ap_idle & acc_U0_ap_idle & I_calc_U0_ap_idle & (size_assign_channel_empty_n ^ 1'b1));
...
assign ap_sync_blockControl_U0_ap_start = (ap_start & (ap_sync_reg_blockControl_U0_ap_ready ^ 1'b1));

assign ap_sync_execute_entry206_U0_ap_ready = (execute_entry206_U0_ap_ready | ap_sync_reg_execute_entry206_U0_ap_ready);

assign ap_sync_execute_entry206_U0_ap_start = (ap_start & (ap_sync_reg_execute_entry206_U0_ap_ready ^ 1'b1));

assign blockControl_U0_ap_continue = 1'b1;

assign blockControl_U0_ap_start = ap_sync_blockControl_U0_ap_start;
...
assign execute_entry206_U0_ap_continue = 1'b1;

assign execute_entry206_U0_ap_start = ap_sync_execute_entry206_U0_ap_start;
