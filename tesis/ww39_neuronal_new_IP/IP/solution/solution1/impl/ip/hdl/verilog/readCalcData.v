...
always @ (*) begin
    if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_condition_79 == 1'b1) & (1'b1 == ap_ce))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_start) & (ap_CS_fsm_state1 == 1'b1)) | ((ap_CS_fsm_state1 == 1'b1) & ~(ap_condition_79 == 1'b1) & (1'b1 == ap_ce)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign F_V_data_00_status = (F_V_data_0_empty_n & F_V_data_1_empty_n & F_V_data_2_empty_n & F_V_data_3_empty_n);
...
assign V_V_data_00_status = (V_V_data_0_empty_n & V_V_data_1_empty_n & V_V_data_2_empty_n & V_V_data_3_empty_n);
...
always @ (*) begin
    ap_condition_79 = ((F_V_data_00_status == 1'b0) | (V_V_data_00_status == 1'b0) | (ap_start == 1'b0));
end
