...
set ID 87
set MemName V_read_voltagesBabkb_memcore
...
set MemName V_read_voltagesBabkb
...
# FIFO definition:
set ID 88
set FifoName V_read_simConfig_cud
...
# FIFO definition:
set ID 89
set FifoName V_read_simConfig_dEe
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 90
set FifoName V_read_simConfig_eOg
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 91
set FifoName V_read_simConfig_fYi
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 92
set FifoName V_read_simConfig_g8j
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 93
set FifoName V_read_V_SIZE_chahbi
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 94
set FifoName V_read_Vi_idx_V_dibs
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 95
set FifoName V_read_Vi_idx_V_djbC
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 96
set FifoName V_read_Vi_idx_V_dkbM
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 97
set FifoName V_read_Vi_idx_V_dlbW
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 98
set FifoName V_read_Vj_idx_V_dmb6
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 99
set FifoName V_read_Vj_idx_V_dncg
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 100
set FifoName V_read_Vj_idx_V_docq
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 101
set FifoName V_read_Vj_idx_V_dpcA
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 102
set FifoName start_for_indexGeqcK
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_V_SIZE_read \
    op interface \
    ports { V_SIZE_read { I 32 vector } V_SIZE_read_ap_vld { I 1 bit } } \
} "
}
