...
set portList { 
	...
	{ V_SIZE_dout sc_in sc_lv 32 signal 1 } 
	{ V_SIZE_empty_n sc_in sc_logic 1 signal 1 } 
	{ V_SIZE_read sc_out sc_logic 1 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"ControlExist" : "1",
		"Port" : [
		{"Name" : "voltagesBackup", "Type" : "Memory", "Direction" : "O"},
...
set Spec2ImplPortList { 
	voltagesBackup { ap_memory {  { voltagesBackup_address0 mem_address 1 14 }  { voltagesBackup_ce0 mem_ce 1 1 }  { voltagesBackup_we0 mem_we 1 1 }  { voltagesBackup_d0 mem_din 1 32 }  { voltagesBackup_address1 mem_address 1 14 }  { voltagesBackup_ce1 mem_ce 1 1 }  { voltagesBackup_we1 mem_we 1 1 }  { voltagesBackup_d1 mem_din 1 32 } } }
