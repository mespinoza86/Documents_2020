...
#ifndef __GapJunctionIP_muludo__HH__
#define __GapJunctionIP_muludo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(GapJunctionIP_muludo) {
    ...
    SC_CTOR(GapJunctionIP_muludo):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
