...
const sc_lv<1> readCalcData::ap_const_lv1_1 = "1";
...
void readCalcData::thread_ap_condition_79() {
    ap_condition_79 = (esl_seteq<1,1,1>(F_V_data_00_status.read(), ap_const_logic_0) || esl_seteq<1,1,1>(V_V_data_00_status.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0));
}
