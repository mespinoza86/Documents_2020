...
#include "V_read_voltagesBabkb.h"
#include "V_read_simConfig_cud.h"
#include "V_read_simConfig_dEe.h"
#include "V_read_simConfig_eOg.h"
#include "V_read_simConfig_fYi.h"
#include "V_read_simConfig_g8j.h"
#include "V_read_V_SIZE_chahbi.h"
#include "V_read_Vi_idx_V_dibs.h"
#include "V_read_Vi_idx_V_djbC.h"
#include "V_read_Vi_idx_V_dkbM.h"
#include "V_read_Vi_idx_V_dlbW.h"
#include "V_read_Vj_idx_V_dmb6.h"
#include "V_read_Vj_idx_V_dncg.h"
#include "V_read_Vj_idx_V_docq.h"
#include "V_read_Vj_idx_V_dpcA.h"
#include "start_for_indexGeqcK.h"
...
struct V_read : public sc_module {
    ...
    V_read_voltagesBabkb* voltagesBackup_U;
    ...
    sc_signal< sc_logic > V_read_entry201214_U0_ap_start;
    sc_signal< sc_logic > V_read_entry201214_U0_ap_done;
    sc_signal< sc_logic > V_read_entry201214_U0_ap_continue;
    sc_signal< sc_logic > V_read_entry201214_U0_ap_idle;
    sc_signal< sc_logic > V_read_entry201214_U0_ap_ready;
    sc_signal< sc_logic > V_read_entry201214_U0_start_out;
    sc_signal< sc_logic > V_read_entry201214_U0_start_write;
    sc_signal< sc_logic > V_read_entry201214_U0_scalar_simConfig_BLOCK_NUMBERS_V_read;
    sc_signal< sc_lv<27> > V_read_entry201214_U0_simConfig_BLOCK_NUMBERS_V_out_din;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_BLOCK_NUMBERS_V_out_write;
    sc_signal< sc_logic > V_read_entry201214_U0_scalar_simConfig_rowsToSimulate_V_read;
    sc_signal< sc_lv<27> > V_read_entry201214_U0_simConfig_rowsToSimulate_V_out_din;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_rowsToSimulate_V_out_write;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_rowBegin_V_read;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_rowEnd_V_read;
    sc_signal< sc_lv<27> > V_read_entry201214_U0_simConfig_rowBegin_V_channel_i_din;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_rowBegin_V_channel_i_write;
    sc_signal< sc_lv<27> > V_read_entry201214_U0_simConfig_rowEnd_V_channel_i_din;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_rowEnd_V_channel_i_write;
    sc_signal< sc_lv<27> > V_read_entry201214_U0_simConfig_rowsToSimulate_V_channel_i_din;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_rowsToSimulate_V_channel_i_write;
    sc_signal< sc_lv<27> > V_read_entry201214_U0_simConfig_BLOCK_NUMBERS_V_channel_i_din;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_BLOCK_NUMBERS_V_channel_i_write;
    sc_signal< sc_lv<27> > V_read_entry201214_U0_simConfig_BLOCK_NUMBERS_V_channel1_i_din;
    sc_signal< sc_logic > V_read_entry201214_U0_simConfig_BLOCK_NUMBERS_V_channel1_i_write;
    sc_signal< sc_lv<32> > V_read_entry201214_U0_V_SIZE_channel_i_din;
    sc_signal< sc_logic > V_read_entry201214_U0_V_SIZE_channel_i_write;
    ...
    sc_signal< sc_logic > writeV2calc_U0_simConfig_rowsToSimu_read;
    ...
    sc_signal< sc_logic > simConfig_rowBegin_V_3_full_n;
    sc_signal< sc_lv<27> > simConfig_rowBegin_V_3_dout;
    sc_signal< sc_logic > simConfig_rowBegin_V_3_empty_n;
    ...
    sc_signal< sc_logic > V_SIZE_channel_i_full_n;
    sc_signal< sc_lv<32> > V_SIZE_channel_i_dout;
    sc_signal< sc_logic > V_SIZE_channel_i_empty_n;
    ...
    sc_signal< sc_logic > ap_reg_V_read_entry201214_U0_ap_done;
    sc_signal< sc_logic > ap_reg_writeV2calc_U0_ap_done;
    sc_signal< sc_logic > ap_hs_ready;
    sc_signal< sc_logic > ap_sync_reg_V_read_entry201214_U0_ap_ready;
    sc_signal< sc_logic > ap_sync_V_read_entry201214_U0_ap_ready;
    sc_signal< sc_lv<2> > V_read_entry201214_U0_ap_ready_count;
    ...
    sc_signal< sc_logic > ap_sync_V_read_entry201214_U0_ap_start;
    sc_signal< sc_logic > ap_sync_readVoltages_U0_ap_start;
    ...
    void thread_V_read_entry201214_U0_ap_continue();
    void thread_V_read_entry201214_U0_ap_start();
    ...
    void thread_ap_sync_V_read_entry201214_U0_ap_ready();
    void thread_ap_sync_V_read_entry201214_U0_ap_start();
    void thread_ap_sync_readVoltages_U0_ap_ready();
    void thread_ap_sync_readVoltages_U0_ap_start();
