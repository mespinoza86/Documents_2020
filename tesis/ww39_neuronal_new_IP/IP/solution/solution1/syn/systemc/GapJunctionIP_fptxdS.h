...
#ifndef __GapJunctionIP_fptxdS__HH__
#define __GapJunctionIP_fptxdS__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(GapJunctionIP_fptxdS) {
    ...
    SC_CTOR(GapJunctionIP_fptxdS):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
