...
#ifndef __GapJunctionIP_mulwdI__HH__
#define __GapJunctionIP_mulwdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(GapJunctionIP_mulwdI) {
    ...
    SC_CTOR(GapJunctionIP_mulwdI):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
