...
proc create_root_design { parentCell } {
  ...
  # Create instance: GapJunctionIP_0, and set properties
  set GapJunctionIP_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:GapJunctionIP:1.0 GapJunctionIP_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins GapJunctionIP_0/input_V_data] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins GapJunctionIP_0/s_axi_AXILiteS] [get_bd_intf_pins axi_interconnect_1/M00_AXI]
  ...
  connect_bd_net -net GapJunctionIP_0_interrupt [get_bd_pins GapJunctionIP_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net GapJunctionIP_0_output_r_TDATA [get_bd_pins GapJunctionIP_0/output_r_TDATA] [get_bd_pins axi_dma_0/s_axis_s2mm_tdata]
  connect_bd_net -net GapJunctionIP_0_output_r_TLAST [get_bd_pins GapJunctionIP_0/output_r_TLAST] [get_bd_pins axi_dma_0/s_axis_s2mm_tlast]
  connect_bd_net -net GapJunctionIP_0_output_r_TVALID [get_bd_pins GapJunctionIP_0/output_r_TVALID] [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid]
  ...
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins GapJunctionIP_0/output_r_TREADY] [get_bd_pins axi_dma_0/s_axis_s2mm_tready]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins GapJunctionIP_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs GapJunctionIP_0/s_axi_AXILiteS/Reg] SEG_GapJunctionIP_0_Reg
