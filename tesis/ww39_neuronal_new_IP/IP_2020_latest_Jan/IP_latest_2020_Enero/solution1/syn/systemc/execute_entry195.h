...
#ifndef _execute_entry195_HH_
#define _execute_entry195_HH_
...
struct execute_entry195 : public sc_module {
    ...
    sc_out< sc_lv<27> > simConfig_rowsToSimulate_V_out1_din;
    sc_in< sc_logic > simConfig_rowsToSimulate_V_out1_full_n;
    sc_out< sc_logic > simConfig_rowsToSimulate_V_out1_write;
    ...
    sc_out< sc_lv<27> > simConfig_BLOCK_NUMBERS_V_out2_din;
    sc_in< sc_logic > simConfig_BLOCK_NUMBERS_V_out2_full_n;
    sc_out< sc_logic > simConfig_BLOCK_NUMBERS_V_out2_write;
    sc_out< sc_lv<32> > size_out_din;
    sc_in< sc_logic > size_out_full_n;
    sc_out< sc_logic > size_out_write;
    sc_out< sc_lv<32> > size_out3_din;
    sc_in< sc_logic > size_out3_full_n;
    sc_out< sc_logic > size_out3_write;


    // Module declarations
    execute_entry195(sc_module_name name);
    SC_HAS_PROCESS(execute_entry195);
    ...
    sc_signal< sc_logic > simConfig_rowsToSimulate_V_out1_blk_n;
    sc_signal< sc_logic > simConfig_BLOCK_NUMBERS_V_out_blk_n;
    sc_signal< sc_logic > simConfig_BLOCK_NUMBERS_V_out2_blk_n;
    sc_signal< sc_logic > size_out_blk_n;
    sc_signal< sc_logic > size_out3_blk_n;
    ...
    void thread_simConfig_BLOCK_NUMBERS_V_out2_blk_n();
    void thread_simConfig_BLOCK_NUMBERS_V_out2_din();
    void thread_simConfig_BLOCK_NUMBERS_V_out2_write();
    ...
    void thread_simConfig_rowsToSimulate_V_out1_blk_n();
    void thread_simConfig_rowsToSimulate_V_out1_din();
    void thread_simConfig_rowsToSimulate_V_out1_write();
    ...
    void thread_size_out3_blk_n();
    void thread_size_out3_din();
    void thread_size_out3_write();
