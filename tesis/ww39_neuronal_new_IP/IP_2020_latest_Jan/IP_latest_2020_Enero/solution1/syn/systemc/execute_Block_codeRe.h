...
#ifndef _execute_Block_codeRe_HH_
#define _execute_Block_codeRe_HH_
...
struct execute_Block_codeRe : public sc_module {
    ...
    // Module declarations
    execute_Block_codeRe(sc_module_name name);
    SC_HAS_PROCESS(execute_Block_codeRe);
