...
set portList { 
	...
	{ V_data_V_data_0_din sc_out sc_lv 32 signal 4 } 
	{ V_data_V_data_0_full_n sc_in sc_logic 1 signal 4 } 
	{ V_data_V_data_0_write sc_out sc_logic 1 signal 4 } 
	{ V_data_V_data_1_din sc_out sc_lv 32 signal 5 } 
	{ V_data_V_data_1_full_n sc_in sc_logic 1 signal 5 } 
	{ V_data_V_data_1_write sc_out sc_logic 1 signal 5 } 
	{ V_data_V_data_2_din sc_out sc_lv 32 signal 6 } 
	{ V_data_V_data_2_full_n sc_in sc_logic 1 signal 6 } 
	{ V_data_V_data_2_write sc_out sc_logic 1 signal 6 } 
	{ V_data_V_data_3_din sc_out sc_lv 32 signal 7 } 
	{ V_data_V_data_3_full_n sc_in sc_logic 1 signal 7 } 
	{ V_data_V_data_3_write sc_out sc_logic 1 signal 7 } 
	{ C_data_V_data_0_din sc_out sc_lv 32 signal 8 } 
	{ C_data_V_data_0_full_n sc_in sc_logic 1 signal 8 } 
	{ C_data_V_data_0_write sc_out sc_logic 1 signal 8 } 
	{ C_data_V_data_1_din sc_out sc_lv 32 signal 9 } 
	{ C_data_V_data_1_full_n sc_in sc_logic 1 signal 9 } 
	{ C_data_V_data_1_write sc_out sc_logic 1 signal 9 } 
	{ C_data_V_data_2_din sc_out sc_lv 32 signal 10 } 
	{ C_data_V_data_2_full_n sc_in sc_logic 1 signal 10 } 
	{ C_data_V_data_2_write sc_out sc_logic 1 signal 10 } 
	{ C_data_V_data_3_din sc_out sc_lv 32 signal 11 } 
	{ C_data_V_data_3_full_n sc_in sc_logic 1 signal 11 } 
	{ C_data_V_data_3_write sc_out sc_logic 1 signal 11 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "input_V_data", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getConductances_fu_70", "Port" : "input_V_data"},
					{"ID" : "2", "SubInstance" : "grp_getVoltages_fu_86", "Port" : "input_V_data"}]},
			...
			{"Name" : "V_SIZE", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "V_SIZE_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "V_data_V_data_0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_getVoltages_fu_86", "Port" : "V_data_V_data_0"}]},
			{"Name" : "V_data_V_data_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_getVoltages_fu_86", "Port" : "V_data_V_data_1"}]},
			{"Name" : "V_data_V_data_2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_getVoltages_fu_86", "Port" : "V_data_V_data_2"}]},
			{"Name" : "V_data_V_data_3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_getVoltages_fu_86", "Port" : "V_data_V_data_3"}]},
			{"Name" : "C_data_V_data_0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getConductances_fu_70", "Port" : "C_data_V_data_0"}]},
			{"Name" : "C_data_V_data_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getConductances_fu_70", "Port" : "C_data_V_data_1"}]},
			{"Name" : "C_data_V_data_2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getConductances_fu_70", "Port" : "C_data_V_data_2"}]},
			{"Name" : "C_data_V_data_3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getConductances_fu_70", "Port" : "C_data_V_data_3"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_getConductances_fu_70", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_getVoltages_fu_86", "Parent" : "0",
		"CDFG" : "getVoltages",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
