...
HD_PWD='/home/marco/Documents/tesis/project_again/HLS/solution1/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Simulate_HW.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Simulate_HW.tcl
